...
<CardGroup cols={2}>
  ...
  <Card title="问题反馈" icon="bug" href="/zh/support/issues">
    报告 Bug 或请求新功能
  </Card>
  <Card title="贡献指南" icon="heart" href="/zh/contributing">
    了解如何为 MCPHub 项目做出贡献
  </Card>
</CardGroup>
...
<Note>
  **v2.1.0 已发布** - 新增 WebHook 支持、改进的监控界面和性能优化。查看 [更新日志](/zh/changelog)
  了解详细信息。
</Note>
...
- 📈 **高级分析** - 更详细的性能分析和预测性监控
- 🔒 **增强安全** - 支持 RBAC 和更多认证方式
- 🌐 **多区域部署** - 跨区域的智能路由和故障转移
- 🎯 **A/B 测试** - 内置的流量分割和实验功能

准备好开始了吗？[立即部署 MCPHub](/zh/quickstart) 🚀
